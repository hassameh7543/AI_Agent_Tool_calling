...
# here is the schema of the tool because llm can't directly interact with tool is just give you the best suggestion which tool use where
# here is the tool name and below is the descritpion
weather_tool_schema = {
    "type": "function",
    "function": {
